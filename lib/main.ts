...
// };
// const getLogBuffer = () => {
//     return [...logBuffer]; // cloning the array to prevent mutation
// };
...
// 
// const sendEmptyIndex = (file: string, res: Response, err) => {
//     if (file === 'index.json') {
...
// const parseIndex = (req: express.Request, res: express.Response, obj: { status: string, url: string }) => {
...
const serveFSLogger = (logsApiUrl: string = '/logs', logsPath: string = './logs') => {
...
const serveS3Logger = (logsApiUrl: string, bucket = '', path = '') => {
    // const s3Client = new AWS.S3();
